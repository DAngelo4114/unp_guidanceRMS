		...
		<table id="studentRecordsTable" class="table table-striped table-responsive" cellspacing="0" width="100%">
		    ...
		    @foreach($students as $student)
		    	<tr>
		    		...
		    		<td class="align-left"><strong class = "text-primary">{{ $student->lname}}</strong>, {{ $student->fname.' '.$student->mname }}</td>
		    		...
		    		<td class="text-center">
					    ...
					    <div class="btn-group col-md-6">
					      ...
					      <ul class="dropdown-menu">
					        ...
					        <li><a data-bind = "click: function(){ edit({{ $student->id }})}" href="#">Add</a></li>
