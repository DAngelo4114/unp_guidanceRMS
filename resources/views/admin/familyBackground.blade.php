				...
				<div class="panel-body">
					<div class="form-group">
						<div class="col-md-6">
							...
							<select data-bind = "options: $root.datas.students, optionsText: studentFullName, 
								optionsValue:'id',optionsCaption:'Select Student',value: student_id" class="form-control">
							</select>
						</div>
					</div>
